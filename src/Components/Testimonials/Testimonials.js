                        ...
                        <OwlCarousel className="testimonials_carousel"  {...options}>
                            <div className='testimonial_item'>
                                <div className='testimonial_img'>
                                    <img src="images/jordan.webp" alt="image" />
                                </div>
                                <div className='testimonial_content'>
                                    ...
                                    <h3 className='testimonial_title'>Jordan Baker</h3>
                                    <p className='designation'>Chief technology officer</p>
                                    <div className='testimonial_desc'>
                                    “Excellent service as always. We have worked on many projects together now and the work gets better and better. Really happy to recommend and look forward to the next project.”
                                    </div>
                                </div>
                            </div>
                            <div className='testimonial_item'>
